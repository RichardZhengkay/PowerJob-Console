            ...
            <div @click="markedSuccess">
              <el-tooltip :content="$t('message.markerSuccess')" placement="top" effect="light">
                <i class="el-icon-document-checked"
                   :style="{'color': selectNode && selectNode.get('model').status === 4 ? '#3D3E3E' : '#BBBBBB'}"></i>
              </el-tooltip>
            </div>
              ...
              <el-row class="job-detail-text" v-if="nodeDetail && nodeDetail.nodeType == 2">
                <el-col :span="24">
                  <span class="power-job-text"
                        :style="{width: nodeDetail.nodeType == 2 ? '64px' : ''}">{{ $t('message.nodeParams') }}:</span>
                  <div :style="{paddingTop: '10px'}">
                    <JSEditor :code="nodeDetail.nodeParams" key="nodeParams"
                              :editorOptions="{readOnly: true}"></JSEditor>
                  </div>
