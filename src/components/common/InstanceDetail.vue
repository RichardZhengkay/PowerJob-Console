<template>
  <div class="power-job-panl">
    <div class="power-job-info" :style="{ width: fixedWidth ? fixedWidth : '100%' }">
      <el-card>
        ...
        <el-row class="job-detail-text">
          <el-col :span="24">
            <span class="power-job-text"
                  :style="{width: instanceDetail.nodeType === 2 ? '64px' : ''}">{{ $t('message.status') }}:</span>
        ...
        <el-row class="job-detail-text">
          <el-col :span="24">
            <span class="power-job-text"
                  :style="{width: instanceDetail.nodeType === 2 ? '64px' : ''}">{{ $t('message.startTime') }}:</span>
        ...
        <el-row class="job-detail-text">
          <el-col :span="24">
            <span class="power-job-text"
                  :style="{width: instanceDetail.nodeType === 2 ? '64px' : ''}">{{ $t('message.finishedTime') }}:</span>
        ...
        <el-row class="job-detail-text">
          <el-col :span="24">
            ...
            >
              <span class="power-job-text"
                    :style="{width: instanceDetail.nodeType === 2 ? '64px' : ''}">{{ $t('message.result') }}:</span>
              <el-popover
                  width="400"
                  placement="right"
                  trigger="click"
        ...
        <slot></slot>
        <el-row class="job-detail-text" id="taskDetail"
    ...
    >{{ $t('message.queriedTaskDetailInfoList') }}
    </el-divider>
