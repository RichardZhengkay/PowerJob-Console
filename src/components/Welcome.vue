 <template>
     <div id="container">
         ...
         <div id="welcome">
             ...
             <!-- 应用注册弹窗 -->
             <el-dialog :title="$t('message.appRegister')" :visible.sync="appRegisterFormVisible" width="50%" >
             ...
             <!-- 用户注册弹窗 -->
             <el-dialog :title="$t('message.userRegister')" :visible.sync="userRegisterFormVisible" width="50%" >
